    ...
    if (bundles.length > 0) {
      for (const bundle of bundles) {
        ...
        if (adminDiscountApplied > 0) {
          const discountAmount = (bundle.finalPrice * adminDiscountApplied) / 100;
        ...
        if (adminDiscount > 0) {
          const discountAmount = (bundle.finalPrice * adminDiscount) / 100;
          const adminDiscountedPrice = bundle.finalPrice - discountAmount;
          bundle.finalPrice = adminDiscountedPrice;
        }
